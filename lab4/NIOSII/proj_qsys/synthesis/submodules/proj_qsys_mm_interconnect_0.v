...
// 
// Generated using ACDS version 14.0 200 at 2017.02.20.20:44:13
...
module proj_qsys_mm_interconnect_0 (
	...
	wire  [92:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> onchip_mem_s1_agent:cp_data
	wire   [5:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	wire   [5:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire  [93:0] sys_clk_timer_s1_agent_rf_source_data;                                     // sys_clk_timer_s1_agent:rf_source_data -> sys_clk_timer_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] sys_clk_timer_s1_agent_rsp_fifo_out_data;                                  // sys_clk_timer_s1_agent_rsp_fifo:out_data -> sys_clk_timer_s1_agent:rf_sink_data
	...
	wire         sys_clk_timer_s1_agent_rdata_fifo_src_valid;                               // sys_clk_timer_s1_agent:rdata_fifo_src_valid -> sys_clk_timer_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] sys_clk_timer_s1_agent_rdata_fifo_src_data;                                // sys_clk_timer_s1_agent:rdata_fifo_src_data -> sys_clk_timer_s1_agent:rdata_fifo_sink_data
	wire         sys_clk_timer_s1_agent_rdata_fifo_src_ready;                               // sys_clk_timer_s1_agent:rdata_fifo_sink_ready -> sys_clk_timer_s1_agent:rdata_fifo_src_ready
	...
	wire  [92:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> sys_clk_timer_s1_agent:cp_data
	...
	wire  [93:0] sysid_control_slave_agent_rf_source_data;                                  // sysid_control_slave_agent:rf_source_data -> sysid_control_slave_agent_rsp_fifo:in_data
	...
	wire  [93:0] sysid_control_slave_agent_rsp_fifo_out_data;                               // sysid_control_slave_agent_rsp_fifo:out_data -> sysid_control_slave_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> sysid_control_slave_agent:cp_data
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire  [93:0] led_pio_s1_agent_rf_source_data;                                           // led_pio_s1_agent:rf_source_data -> led_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] led_pio_s1_agent_rsp_fifo_out_data;                                        // led_pio_s1_agent_rsp_fifo:out_data -> led_pio_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> led_pio_s1_agent:cp_data
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [16:0] cpu_jtag_debug_module_agent_m0_address;                                    // cpu_jtag_debug_module_agent:m0_address -> cpu_jtag_debug_module_translator:uav_address
	...
	wire  [93:0] cpu_jtag_debug_module_agent_rf_source_data;                                // cpu_jtag_debug_module_agent:rf_source_data -> cpu_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [93:0] cpu_jtag_debug_module_agent_rsp_fifo_out_data;                             // cpu_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_jtag_debug_module_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> cpu_jtag_debug_module_agent:cp_endofpacket
	wire         cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> cpu_jtag_debug_module_agent:cp_valid
	wire         cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> cpu_jtag_debug_module_agent:cp_startofpacket
	wire  [92:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> cpu_jtag_debug_module_agent:cp_data
	wire   [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> cpu_jtag_debug_module_agent:cp_channel
	wire         cmd_mux_005_src_ready;                                                     // cpu_jtag_debug_module_agent:cp_ready -> cmd_mux_005:src_ready
	...
	wire  [92:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [92:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                 // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [92:0] sys_clk_timer_s1_agent_rp_data;                                            // sys_clk_timer_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] led_pio_s1_agent_rp_data;                                                  // led_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_007:sink_data
	...
	wire  [92:0] router_001_src_data;                                                       // router_001:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	...
	wire  [92:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [92:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	...
	wire  [92:0] cpu_instruction_master_limiter_rsp_src_data;                               // cpu_instruction_master_limiter:rsp_src_data -> cpu_instruction_master_agent:rp_data
	...
	wire  [92:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_005:sink0_data
	...
	wire  [92:0] rsp_demux_005_src0_data;                                                   // rsp_demux_005:src0_data -> rsp_mux_001:sink1_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (sys_clk_timer_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (sys_clk_timer_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (sys_clk_timer_s1_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (led_pio_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (led_pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (led_pio_s1_agent_rdata_fifo_src_data),        //                .data
	...
	proj_qsys_mm_interconnect_0_router router (
	...
	proj_qsys_mm_interconnect_0_router_001 router_001 (
	...
	proj_qsys_mm_interconnect_0_router_002 router_002 (
	...
	proj_qsys_mm_interconnect_0_router_003 router_003 (
	...
	proj_qsys_mm_interconnect_0_router_003 router_004 (
	...
	proj_qsys_mm_interconnect_0_router_003 router_005 (
	...
	proj_qsys_mm_interconnect_0_router_003 router_006 (
	...
	proj_qsys_mm_interconnect_0_router_007 router_007 (
	...
	proj_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
