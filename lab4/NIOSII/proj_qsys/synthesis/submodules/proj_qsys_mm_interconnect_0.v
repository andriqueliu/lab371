...
// 
// Generated using ACDS version 14.0 200 at 2017.02.15.23:36:45
...
module proj_qsys_mm_interconnect_0 (
	...
	wire         rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> nios2_gen2_0_instruction_master_agent:rp_endofpacket
	wire         rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> nios2_gen2_0_instruction_master_agent:rp_valid
	wire         rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> nios2_gen2_0_instruction_master_agent:rp_startofpacket
	wire  [87:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	wire   [2:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_gen2_0_instruction_master_agent:rp_channel
	wire         rsp_mux_src_ready;                                                                  // nios2_gen2_0_instruction_master_agent:rp_ready -> rsp_mux:src_ready
	...
	wire  [87:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_gen2_0_data_master_agent:rp_data
	wire   [2:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> nios2_gen2_0_data_master_agent:rp_channel
	...
	wire  [87:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	wire   [2:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	wire         cmd_mux_002_src_ready;                                                              // jtag_uart_0_avalon_jtag_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire         nios2_gen2_0_instruction_master_agent_cp_endofpacket;                               // nios2_gen2_0_instruction_master_agent:cp_endofpacket -> router:sink_endofpacket
	wire         nios2_gen2_0_instruction_master_agent_cp_valid;                                     // nios2_gen2_0_instruction_master_agent:cp_valid -> router:sink_valid
	wire         nios2_gen2_0_instruction_master_agent_cp_startofpacket;                             // nios2_gen2_0_instruction_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire  [87:0] nios2_gen2_0_instruction_master_agent_cp_data;                                      // nios2_gen2_0_instruction_master_agent:cp_data -> router:sink_data
	wire         nios2_gen2_0_instruction_master_agent_cp_ready;                                     // router:sink_ready -> nios2_gen2_0_instruction_master_agent:cp_ready
	...
	wire  [87:0] nios2_gen2_0_data_master_agent_cp_data;                                             // nios2_gen2_0_data_master_agent:cp_data -> router_001:sink_data
	...
	wire  [87:0] jtag_uart_0_avalon_jtag_slave_agent_rp_data;                                        // jtag_uart_0_avalon_jtag_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [87:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_002:sink0_data
	...
	wire  [87:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> rsp_mux_001:sink2_data
	...
	proj_qsys_mm_interconnect_0_router_002 router_003 (
	...
	proj_qsys_mm_interconnect_0_router_004 router_004 (
	...
	proj_qsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_cmd_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	proj_qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
