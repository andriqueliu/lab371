...
# ACDS 14.0 200 win32 2017.02.20.20:43:57
...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_rsp_mux_001.sv"   -work rsp_mux_001                   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                  -work rsp_mux                       
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_rsp_mux.sv"       -work rsp_mux                       
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_rsp_demux_001.sv" -work rsp_demux_001                 
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_rsp_demux.sv"     -work rsp_demux                     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                  -work cmd_mux_001                   
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_cmd_mux_001.sv"   -work cmd_mux_001                   
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                  -work cmd_mux                       
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_cmd_mux.sv"       -work cmd_mux                       
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_cmd_demux_001.sv" -work cmd_demux_001                 
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_cmd_demux.sv"     -work cmd_demux                     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"             -work cpu_instruction_master_limiter
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"              -work cpu_instruction_master_limiter
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                      -work cpu_instruction_master_limiter
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"             -work cpu_instruction_master_limiter
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_router_007.sv"    -work router_007                    
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_router_003.sv"    -work router_003                    
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_router_002.sv"    -work router_002                    
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_router_001.sv"    -work router_001                    
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_mm_interconnect_0_router.sv"        -work router                        
  vlog     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                      -work onchip_mem_s1_agent_rsp_fifo  
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                 -work onchip_mem_s1_agent           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"          -work onchip_mem_s1_agent           
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                -work cpu_data_master_agent         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"            -work onchip_mem_s1_translator      
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"           -work cpu_data_master_translator    
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/proj_qsys_irq_mapper.sv"                      -work irq_mapper                    
