...
module lab4_mm_interconnect_0 (
	...
	wire  [92:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [92:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> cpu_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // cpu_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> cpu_jtag_debug_module_agent:cp_channel
	...
	wire  [92:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> onchip_mem_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // onchip_mem_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> sys_clk_timer_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // sys_clk_timer_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> sys_clk_timer_s1_agent:cp_channel
	...
	wire  [92:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [92:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [92:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] sys_clk_timer_s1_agent_rp_data;                                            // sys_clk_timer_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] led_pio_s1_agent_rp_data;                                                  // led_pio_s1_agent:rp_data -> router_007:sink_data
	...
	lab4_mm_interconnect_0_router router (
	...
	lab4_mm_interconnect_0_router_001 router_001 (
	...
	lab4_mm_interconnect_0_router_002 router_002 (
	...
	lab4_mm_interconnect_0_router_002 router_003 (
	...
	lab4_mm_interconnect_0_router_004 router_004 (
	...
	lab4_mm_interconnect_0_router_004 router_005 (
	...
	lab4_mm_interconnect_0_router_002 router_006 (
	...
	lab4_mm_interconnect_0_router_002 router_007 (
	...
	lab4_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                        //        clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab4_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
