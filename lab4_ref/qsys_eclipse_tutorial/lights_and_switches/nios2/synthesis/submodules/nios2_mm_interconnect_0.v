...
module nios2_mm_interconnect_0 (
		...
		input  wire [14:0] nios2_processor_data_master_address,                 //                   nios2_processor_data_master.address
		...
		input  wire [14:0] nios2_processor_instruction_master_address,          //            nios2_processor_instruction_master.address
		...
		output wire [10:0] onchip_memory_s1_address,                            //                              onchip_memory_s1.address
	...
	wire  [14:0] nios2_processor_data_master_translator_avalon_universal_master_0_address;              // nios2_processor_data_master_translator:uav_address -> nios2_processor_data_master_agent:av_address
	...
	wire  [90:0] rsp_mux_src_data;                                                                      // rsp_mux:src_data -> nios2_processor_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                                     // nios2_processor_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                                   // rsp_mux:src_channel -> nios2_processor_data_master_agent:rp_channel
	...
	wire  [14:0] nios2_processor_instruction_master_translator_avalon_universal_master_0_address;       // nios2_processor_instruction_master_translator:uav_address -> nios2_processor_instruction_master_agent:av_address
	...
	wire  [90:0] rsp_mux_001_src_data;                                                                  // rsp_mux_001:src_data -> nios2_processor_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                                 // nios2_processor_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [4:0] rsp_mux_001_src_channel;                                                               // rsp_mux_001:src_channel -> nios2_processor_instruction_master_agent:rp_channel
	...
	wire  [90:0] cmd_mux_src_data;                                                                      // cmd_mux:src_data -> jtag_uart_avalon_jtag_slave_agent:cp_data
	...
	wire  [14:0] nios2_processor_jtag_debug_module_agent_m0_address;                                    // nios2_processor_jtag_debug_module_agent:m0_address -> nios2_processor_jtag_debug_module_translator:uav_address
	...
	wire  [91:0] nios2_processor_jtag_debug_module_agent_rf_source_data;                                // nios2_processor_jtag_debug_module_agent:rf_source_data -> nios2_processor_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [91:0] nios2_processor_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_processor_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_processor_jtag_debug_module_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                                  // cmd_mux_001:src_data -> nios2_processor_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                                 // nios2_processor_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                               // cmd_mux_001:src_channel -> nios2_processor_jtag_debug_module_agent:cp_channel
	...
	wire  [14:0] onchip_memory_s1_agent_m0_address;                                                     // onchip_memory_s1_agent:m0_address -> onchip_memory_s1_translator:uav_address
	...
	wire  [91:0] onchip_memory_s1_agent_rf_source_data;                                                 // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] onchip_memory_s1_agent_rsp_fifo_out_data;                                              // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_002_src_data;                                                                  // cmd_mux_002:src_data -> onchip_memory_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                                 // onchip_memory_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [4:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> onchip_memory_s1_agent:cp_channel
	...
	wire  [91:0] switches_s1_agent_rf_source_data;                                                      // switches_s1_agent:rf_source_data -> switches_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] switches_s1_agent_rsp_fifo_out_data;                                                   // switches_s1_agent_rsp_fifo:out_data -> switches_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                                  // cmd_mux_003:src_data -> switches_s1_agent:cp_data
	...
	wire  [91:0] leds_s1_agent_rf_source_data;                                                          // LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] leds_s1_agent_rsp_fifo_out_data;                                                       // LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [90:0] nios2_processor_data_master_agent_cp_data;                                             // nios2_processor_data_master_agent:cp_data -> router:sink_data
	...
	wire  [90:0] nios2_processor_instruction_master_agent_cp_data;                                      // nios2_processor_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [90:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                             // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [90:0] nios2_processor_jtag_debug_module_agent_rp_data;                                       // nios2_processor_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] onchip_memory_s1_agent_rp_data;                                                        // onchip_memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [90:0] switches_s1_agent_rp_data;                                                             // switches_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] leds_s1_agent_rp_data;                                                                 // LEDs_s1_agent:rp_data -> router_006:sink_data
